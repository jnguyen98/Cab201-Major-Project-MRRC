...
namespace MRRCManagement
{
    ...
    public class CRM
    {
        ...
        private string[] CustomersCsvLines;
        ...
        public CRM(string CrmFile)
        {
            ...
            // If fleet file doesn't exist, throw exception
            else
            {
                throw new Exception($"Error: Specified file path {CrmFile} does not contain customers.csv file");
            }
        }
        #endregion
