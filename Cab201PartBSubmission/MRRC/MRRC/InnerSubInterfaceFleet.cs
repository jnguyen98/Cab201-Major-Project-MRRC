    ...
    public class InnerSubInterfaceFleet : SubInterface
    {
        ...
        private void NumSeatsValidInput()
        {
            ...
            do
            {
                ...
                else if (NumSeats > 10)
                {
                    ...
                    Console.WriteLine("Enter a valid number of seats which is between 0 and 10\n");
                    NumSeatsIsValid = false;
                }
        ...
        private void AddDefaultVehicle(string GradeOption = "None", bool clear = true, bool GradeProvided = false)
        {
            ...
            if (GradeProvided)
            {
                ...
                {
                    Console.Write("\nSuccessfully added new vehicle '{0} - {1} {2} {3}' and added to vehicle list", registration, grade, make, model);
